...
static const std::map<llm_kv, const char *> LLM_KV_NAMES = {
    ...
    { LLM_KV_ATTENTION_LOOP_NUM,                     "%s.loop.num"                               },
    { LLM_KV_ATTENTION_LOOP_WINDOW_SIZE,             "%s.loop.window_size"                       },
...
static const std::map<llm_tensor, const char *> LLM_TENSOR_NAMES = {
    ...
    { LLM_TENSOR_ATTN_LOOP_GATE,                         "blk.%d.loop_gate" },
...
static const std::map<llm_tensor, llm_tensor_info> LLM_TENSOR_INFOS = {
    ...
    {LLM_TENSOR_ATTN_LOOP_GATE,             {LLM_TENSOR_LAYER_REPEATING, GGML_OP_MUL_MAT}},
