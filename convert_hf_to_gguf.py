    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.is_mistral_format:
            ...
            n_embd_text = (
                ...
                or text_config.get("projection_dim")
                or 0
            )
...
class JinaCLIPTextModel(XLMRobertaModel):
    ...
    def __init__(self, dir_model: Path, ftype: gguf.LlamaFileType, fname_out: Path, **kwargs: Any):
        jinaclip_hparams = kwargs.pop("hparams", None)
        if jinaclip_hparams is None:
...
class JinaCLIPVisionModel(MmprojModel):
    ...
    def set_gguf_parameters(self):
        ...
        # JinaClip v2 uses mean instead of image_mean in preprocessor_config.json
