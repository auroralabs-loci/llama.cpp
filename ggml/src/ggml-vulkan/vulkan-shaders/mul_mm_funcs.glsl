void load_a_to_shmem(const uint pos_a, const uint row, const uint col, const uint idx_m, const uint block, const uint end_k) {
            ...
            buf_a[buf_idx    ] = FLOAT_TYPE_VEC2((bits & 0x01u) != 0u ? d : -d, (bits & 0x02u) != 0u ? d : -d);
            buf_a[buf_idx + 1] = FLOAT_TYPE_VEC2((bits & 0x04u) != 0u ? d : -d, (bits & 0x08u) != 0u ? d : -d);
            buf_a[buf_idx + 2] = FLOAT_TYPE_VEC2((bits & 0x10u) != 0u ? d : -d, (bits & 0x20u) != 0u ? d : -d);
            buf_a[buf_idx + 3] = FLOAT_TYPE_VEC2((bits & 0x40u) != 0u ? d : -d, (bits & 0x80u) != 0u ? d : -d);
