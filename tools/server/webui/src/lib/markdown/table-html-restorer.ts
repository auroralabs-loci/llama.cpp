 ...
 *
 * ## Problem
 * When Markdown processors parse tables, HTML tags inside cells (like `<br>` or
 * `<ul>`) are often converted to literal text nodes rather than being rendered
 * as actual HTML elements. This plugin post-processes the HAST tree to restore
 * these elements.
 *
 * ## Supported HTML
